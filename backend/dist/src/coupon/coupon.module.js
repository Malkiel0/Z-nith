...
const coupon_resolver_1 = require("./coupon.resolver");
...
exports.CouponModule = CouponModule = __decorate([
    (0, common_1.Module)({
        providers: [coupon_service_1.CouponService, coupon_resolver_1.CouponResolver, prisma_service_1.PrismaService],
    })
], CouponModule);
