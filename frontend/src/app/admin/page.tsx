    ...
    <div className="min-h-screen bg-gradient-to-br from-[#ffe259] via-[#ffa751] to-[#eecda3] flex flex-col items-center justify-center animate-fadein">
      <div className="p-10 rounded-3xl shadow-2xl bg-white/90 flex flex-col gap-6 max-w-2xl w-full animate-slidein">
        ...
        <div className="flex gap-4 justify-center mt-8">
          <button className="px-6 py-3 bg-gradient-to-r from-pink-500 to-yellow-400 text-white font-bold rounded-xl shadow-lg hover:scale-105 transition-transform">Voir les commandes</button>
          <button className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-500 text-white font-bold rounded-xl shadow-lg hover:scale-105 transition-transform">Gestion produits</button>
        </div>
